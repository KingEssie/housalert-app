...
export default function ChangePasswordPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#F8FAFC]" data-testid="page-password-success">
        <PageHeader title="Wachtwoord wijzigen" onBack={() => navigate("/dashboard?tab=profiel")} />
        <div className="max-w-xl mx-auto p-4 pb-8">
          <div className="bg-white rounded-[18px] border border-[#E5E7EB] p-6 text-center">
            ...
            <h2 className="text-[20px] font-bold text-[#111827] mb-2" data-testid="text-success-title">
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]" data-testid="page-change-password">
      <PageHeader title="Wachtwoord wijzigen" onBack={() => navigate("/dashboard?tab=profiel")} />

      <div className="max-w-xl mx-auto p-4 pb-8">
        <div className="bg-white rounded-[18px] border border-[#E5E7EB] p-5 space-y-5">
          <div>
            <label className="block text-[14px] font-medium text-[#111827] mb-2">Huidig wachtwoord</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-[52px] pl-11 pr-12 rounded-[14px] border-0 bg-[#F3F4F6] text-[16px] font-medium text-[#111827] placeholder:text-[#9CA3AF] placeholder:font-normal focus:outline-none focus:ring-2 focus:ring-[#673DE5]/15 focus:bg-white transition-all"
          ...
          <div>
            <label className="block text-[14px] font-medium text-[#111827] mb-2">Nieuw wachtwoord</label>
            <div className="relative">
              <div className="absolute left-4 top-1/2 -translate-y-1/2">
                <Lock className="w-[18px] h-[18px] text-[#9CA3AF]" />
              </div>
            ...
            {newTooShort && (
              <p className="text-[13px] text-[#673DE5] mt-1.5" data-testid="text-error-min-length">
          ...
          <div>
            <label className="block text-[14px] font-medium text-[#111827] mb-2">Nieuw wachtwoord bevestigen</label>
            <div className="relative">
              <div className="absolute left-4 top-1/2 -translate-y-1/2">
                <Lock className="w-[18px] h-[18px] text-[#9CA3AF]" />
              </div>
            ...
            {mismatch && (
              <p className="text-[13px] text-[#673DE5] mt-1.5" data-testid="text-error-mismatch">
        ...
        <button
          ...
          className={`w-full h-[48px] rounded-[14px] font-semibold text-[15px] mt-5 transition-colors ${
            canSubmit
              ? "bg-[#673DE5] hover:bg-[#5B30D6] text-white"
