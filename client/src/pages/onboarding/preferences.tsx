  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col max-w-[480px] mx-auto w-full px-5 pt-6 pb-[100px] overflow-y-auto">
        ...
        <div className="flex flex-col gap-2.5" data-testid="preference-options">
          {PREFERENCE_OPTIONS.map((opt) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center gap-3 p-4 rounded-[10px] text-left transition-all"
                style={{
        ...
        <label className="flex items-center gap-3 cursor-pointer" data-testid="toggle-send-unclear">
          <div
            className="w-[44px] h-[24px] rounded-full p-[2px] transition-colors shrink-0 cursor-pointer"
          ...
          >
            <div
              ...
              style={{ transform: sendUnclear ? "translateX(20px)" : "translateX(0)" }}
            />
          </div>
