  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="w-full bg-white sticky top-0 z-20 border-b border-[#E5E7EB]">
        <div className="max-w-xl mx-auto px-6 h-[60px] flex items-center justify-between">
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate("/")}>
            ...
            <span className="font-extrabold text-[#1F2937] text-xl tracking-tight">Stekkies</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-xl mx-auto px-6 py-10">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-1.5 text-[13px] font-semibold text-[#673DE6] mb-6"
        ...
        <h1 className="text-[32px] font-[800] text-[#1F2937] tracking-[-0.03em] leading-[1.1] mb-10" data-testid="text-legal-title">
          {title}
        </h1>

        <div className="prose prose-sm max-w-none text-[#1F2937] space-y-6">
          {children}
        </div>
      </main>
...
export function ImpressumPage() {
  return (
    <LegalLayout title="Impressum">
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">Angaben gemäß § 5 TMG</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">Vertreten durch</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">Kontakt</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">Registereintrag</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">Umsatzsteuer-ID</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">Streitschlichtung</h2>
        <p className="text-[15px] leading-relaxed">
...
export function DatenschutzPage() {
  return (
    <LegalLayout title="Datenschutzerklärung">
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">1. Datenschutz auf einen Blick</h2>
        <h3 className="text-[15px] font-semibold text-[#1F2937] mb-1">Allgemeine Hinweise</h3>
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">2. Verantwortliche Stelle</h2>
        <p className="text-[15px] leading-relaxed">
          [Firmenname einfügen]<br />
          [Straße und Hausnummer]<br />
          [PLZ und Ort]<br />
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">3. Datenerfassung auf dieser Website</h2>
        <h3 className="text-[15px] font-semibold text-[#1F2937] mb-1">Cookies</h3>
        <p className="text-[15px] leading-relaxed">
        ...
        <h3 className="text-[15px] font-semibold text-[#1F2937] mb-1 mt-4">Server-Log-Dateien</h3>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">4. Analyse-Tools und Werbung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">5. Ihre Rechte</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">6. Zahlungsdienstleister</h2>
        <p className="text-[15px] leading-relaxed">
...
export function TermsPage() {
  return (
    <LegalLayout title="Allgemeine Geschäftsbedingungen">
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 1 Geltungsbereich</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 2 Leistungsbeschreibung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 3 Registrierung und Nutzerkonto</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 4 Preise und Zahlungsbedingungen</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 5 Probezeit und Kündigung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 6 Haftungsbeschränkung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[700] text-[#1F2937] tracking-[-0.01em] mb-3">§ 7 Schlussbestimmungen</h2>
        <p className="text-[15px] leading-relaxed">
