  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="w-full bg-white sticky top-0 z-20 border-b border-[#E8EDF2]">
        <div className="max-w-xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate("/")}>
            ...
            <span className="font-extrabold text-[#0B1F44] text-xl tracking-tight">Stekkies</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-xl mx-auto px-5 py-10">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-1.5 text-[13px] font-semibold text-[#2D6CDF] mb-6"
        ...
        <h1 className="text-[28px] font-extrabold text-[#0B1F44] mb-8" data-testid="text-legal-title">
          {title}
        </h1>
      ...
      <footer className="border-t border-[#E8EDF2] py-8 px-5">
        <div className="max-w-xl mx-auto text-center text-sm text-[#6B7280]">
...
export function ImpressumPage() {
  return (
    <LegalLayout title="Impressum">
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">Angaben gemäß § 5 TMG</h2>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">Vertreten durch</h2>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">Kontakt</h2>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">Registereintrag</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">Umsatzsteuer-ID</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">Streitschlichtung</h2>
        <p className="text-[15px] leading-relaxed">
...
export function DatenschutzPage() {
  return (
    <LegalLayout title="Datenschutzerklärung">
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">1. Datenschutz auf einen Blick</h2>
        <h3 className="text-[15px] font-semibold text-[#0B1F44] mb-1">Allgemeine Hinweise</h3>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">2. Verantwortliche Stelle</h2>
        <p className="text-[15px] leading-relaxed">
          [Firmenname einfügen]<br />
          [Straße und Hausnummer]<br />
          [PLZ und Ort]<br />
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">3. Datenerfassung auf dieser Website</h2>
        <h3 className="text-[15px] font-semibold text-[#0B1F44] mb-1">Cookies</h3>
        <p className="text-[15px] leading-relaxed">
        ...
        <h3 className="text-[15px] font-semibold text-[#0B1F44] mb-1 mt-4">Server-Log-Dateien</h3>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">4. Analyse-Tools und Werbung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">5. Ihre Rechte</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">6. Zahlungsdienstleister</h2>
        <p className="text-[15px] leading-relaxed">
...
export function TermsPage() {
  return (
    <LegalLayout title="Allgemeine Geschäftsbedingungen">
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 1 Geltungsbereich</h2>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 2 Leistungsbeschreibung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 3 Registrierung und Nutzerkonto</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 4 Preise und Zahlungsbedingungen</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 5 Probezeit und Kündigung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 6 Haftungsbeschränkung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-lg font-bold text-[#0B1F44] mb-2">§ 7 Schlussbestimmungen</h2>
        <p className="text-[15px] leading-relaxed">
