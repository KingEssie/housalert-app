  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-xl mx-auto px-6 py-10">
        ...
        <h1 className="text-[32px] font-[600] tracking-[-0.03em] leading-[1.1] mb-10" style={{ color: "rgb(var(--ha-text))" }} data-testid="text-legal-title">
          {title}
        </h1>

        <div className="prose prose-sm max-w-none space-y-6" style={{ color: "rgb(var(--ha-text))" }}>
          {children}
        </div>
      </main>

      <footer className="border-t py-8 px-6" style={{ borderColor: "rgb(var(--ha-card-border))" }}>
...
export function ImpressumPage() {
  return (
    <LegalLayout title="Impressum">
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>Angaben gemäß § 5 TMG</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>Vertreten durch</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>Kontakt</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>Registereintrag</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>Umsatzsteuer-ID</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>Streitschlichtung</h2>
        <p className="text-[15px] leading-relaxed">
...
export function DatenschutzPage() {
  return (
    <LegalLayout title="Datenschutzerklärung">
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>1. Datenschutz auf einen Blick</h2>
        <h3 className="text-[15px] font-medium mb-1" style={{ color: "rgb(var(--ha-text))" }}>Allgemeine Hinweise</h3>
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>2. Verantwortliche Stelle</h2>
        <p className="text-[15px] leading-relaxed">
          [Firmenname einfügen]<br />
          [Straße und Hausnummer]<br />
          [PLZ und Ort]<br />
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>3. Datenerfassung auf dieser Website</h2>
        <h3 className="text-[15px] font-medium mb-1" style={{ color: "rgb(var(--ha-text))" }}>Cookies</h3>
        <p className="text-[15px] leading-relaxed">
        ...
        <h3 className="text-[15px] font-medium mb-1 mt-4" style={{ color: "rgb(var(--ha-text))" }}>Server-Log-Dateien</h3>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>4. Analyse-Tools und Werbung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>5. Ihre Rechte</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>6. Zahlungsdienstleister</h2>
        <p className="text-[15px] leading-relaxed">
...
export function TermsPage() {
  return (
    <LegalLayout title="Allgemeine Geschäftsbedingungen">
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 1 Geltungsbereich</h2>
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 2 Leistungsbeschreibung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 3 Registrierung und Nutzerkonto</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 4 Preise und Zahlungsbedingungen</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 5 Probezeit und Kündigung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 6 Haftungsbeschränkung</h2>
        <p className="text-[15px] leading-relaxed">
      ...
      <section>
        <h2 className="text-[18px] font-[600] tracking-[-0.01em] mb-3" style={{ color: "rgb(var(--ha-text))" }}>§ 7 Schlussbestimmungen</h2>
        <p className="text-[15px] leading-relaxed">
