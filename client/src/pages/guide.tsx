...
function GuideSection({ title, items }: { title: string; items: string[] }) {
  return (
    <div className="bg-white rounded-lg border border-[#E5E7EB] p-5">
      <h3 className="text-[16px] font-medium text-[#111C3D] mb-3">{title}</h3>
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-xl mx-auto w-full px-6 pb-32">
        <p className="text-[15px] text-[#1F2937] leading-relaxed mb-6" data-testid={`text-guide-intro-${guideId}`}>
          {guide.intro}
        </p>
