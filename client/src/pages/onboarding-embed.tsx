...
function EstimateBlock({ city, maxPrice }: { city: string; maxPrice: string }) {
  ...
  return (
    <div
      className="flex items-center gap-3 bg-gradient-to-r from-[#E6FAF5] to-[#E6FAF5] rounded-[14px] px-4 py-3.5"
      data-testid="embed-estimate-block"
    >
      <div className="w-9 h-9 rounded-[10px] bg-[#2DD4BF] flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex-1 min-w-0">
        {loading ? (
          ...
          <p className="text-[13px] sm:text-[14px] font-semibold text-[var(--yo-dark)] leading-snug">
            ~<span className="text-[#2DD4BF] text-[15px] font-bold">{estimate}</span> matches per week verwacht
          </p>
        ) : null}
      </div>
    </div>
...
function CompletionScreen({ draftId }: { draftId: string }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-10 text-center">
      <div className="w-[56px] h-[56px] rounded-[14px] bg-[#E6FAF5] flex items-center justify-center mb-5">
      ...
      <p className="text-[14px] text-[var(--yo-muted)] mb-7 max-w-[300px] leading-relaxed">
      ...
      <div className="w-full max-w-[320px] space-y-2.5">
        <a
          href={continueUrl}
          target="_top"
          className="w-full min-h-[56px] rounded-[14px] bg-[#2DD4BF] hover:bg-[#25BBA8] text-white font-bold text-[15px] transition-all flex items-center justify-center gap-2 shadow-[0_2px_12px_rgba(45,212,191,0.3)]"
        ...
        <button
          className="w-full h-[56px] rounded-[14px] border border-[var(--yo-divider)] bg-white text-[var(--yo-dark)] font-semibold text-[14px] transition-colors flex items-center justify-center gap-2"
      ...
      <p className="text-[11px] text-[var(--yo-muted)] mt-6">
        Powered by Stekkies
      </p>
    </div>
  );
  ...
  if (draftId) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="w-full max-w-[440px] bg-white rounded-[16px] border border-[var(--yo-divider)] shadow-[0_4px_24px_rgba(0,0,0,0.06)] overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-white flex items-start justify-center px-4 py-6 sm:py-8">
      <div className="w-full max-w-[440px]">
        ...
        <div className="bg-white rounded-[16px] border border-[var(--yo-divider)] shadow-[0_4px_24px_rgba(0,0,0,0.06)] overflow-visible">
          ...
          <div className="px-5 py-3 space-y-3.5">
            ...
            <div>
              <label className="text-[13px] font-semibold text-[var(--yo-muted)] uppercase tracking-wide mb-2 block">
                Woningtype
              </label>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--yo-muted)] text-[13px] font-medium">EUR</span>
                  <input
                    type="number"
                    inputMode="numeric"
                    placeholder="min"
                    ...
                    className="w-full h-[42px] rounded-[14px] bg-[var(--yo-surface)] border-0 pl-[52px] pr-3 text-[14px] text-[var(--yo-dark)] placeholder:text-[var(--yo-muted)] focus:outline-none focus:ring-2 focus:ring-[#2DD4BF]/40 transition-shadow"
            ...
            <div className="flex items-center gap-2 text-[12px] text-[var(--yo-muted)]">
          ...
          {error && (
            <div className="mx-5 mb-2 p-3 rounded-[14px] bg-red-50 border border-red-200 text-red-700 text-[13px]" data-testid="embed-error">
              {error}
            </div>
          )}
          ...
          <div className="px-5 pb-5 pt-1">
            <button
              ...
              className="w-full h-[56px] rounded-[14px] bg-[#2DD4BF] hover:bg-[#25BBA8] active:scale-[0.98] text-white font-bold text-[16px] transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2.5 shadow-[0_2px_12px_rgba(45,212,191,0.35)]"
        ...
        <p className="text-center text-[11px] text-[var(--yo-muted)] mt-4">
          Powered by Stekkies
        </p>
      </div>
    </div>
