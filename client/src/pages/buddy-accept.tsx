...
import { Loader2, Users, CheckCircle2, XCircle, ShieldCheck, Eye, EyeOff, Lock, Mail, User } from "lucide-react";
          ...
          <div className="text-center mb-8">
            ...
            {inviteInfo.owner_name && (
              <p className="text-[16px] text-[#111111] font-medium mb-1" data-testid="text-accept-owner">
                {t("buddyV2.acceptBody").replace("{name}", inviteInfo.owner_name)}
              </p>
            )}
          </div>

          <div className="rounded-[16px] bg-white border border-[#E5E7EB] shadow-[0_1px_3px_rgba(0,0,0,0.03)] p-5 mb-5">
            <div className="flex items-start gap-2.5 bg-[#F9FAFB] rounded-[12px] p-3.5 mb-5">
            ...
            <div className="flex gap-2 mb-5">
              <button
                onClick={() => { setAuthMode("signup"); setAuthError(""); setPassword(""); }}
                className={`flex-1 h-[44px] rounded-[12px] text-[14px] font-semibold transition-colors ${
                  authMode === "signup"
                    ? "bg-ha-primary text-white"
                    : "bg-[#F3F4F6] text-[#334855] hover:bg-[#E5E7EB]"
                }`}
                data-testid="button-auth-mode-signup"
              >
                {t("buddyV2.authSignup")}
              </button>
              <button
              ...
              <div>
                <div className="relative">
                  ...
                  <input
                    ...
                    readOnly
                    className="w-full h-[56px] pl-11 pr-4 rounded-[16px] border border-[#E5E7EB] bg-[#F9FAFB] text-[15px] text-[#6B7280] cursor-not-allowed"
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-[56px] pl-11 pr-4 rounded-[16px] border border-[#E5E7EB] bg-white text-[15px] text-[#111111] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-ha-primary/20 focus:border-ha-primary transition-colors"
              ...
              <div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-[56px] pl-11 pr-12 rounded-[16px] border border-[#E5E7EB] bg-white text-[15px] text-[#111111] placeholder:text-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-ha-primary/20 focus:border-ha-primary transition-colors"
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-[#9CA3AF] hover:text-[#334855]"
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F9FAFB] px-5">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          ...
          {inviteInfo?.owner_name && (
            <p className="text-[16px] text-[#111111] font-medium mb-1" data-testid="text-accept-owner">
              {t("buddyV2.modeBanner").replace("{name}", inviteInfo.owner_name)}
            </p>
          )}
        </div>
