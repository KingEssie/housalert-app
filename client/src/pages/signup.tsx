...
const INPUT_CLS = "w-full h-[48px] pl-11 pr-4 rounded-[12px] border border-[#E5E7EB] bg-white text-[16px] font-medium text-[#111111] placeholder:text-[#334855] placeholder:opacity-55 placeholder:font-normal focus:border-ha-primary focus:ring-1 focus:ring-ha-primary/25 outline-none transition-all";
