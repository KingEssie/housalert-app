...
const INPUT_CLS = "w-full h-[44px] pl-11 pr-4 rounded-[6px] border border-ha-card-border bg-ha-bg text-[15px] font-medium text-ha-text placeholder:text-ha-text-muted placeholder:font-normal focus:border-ha-primary focus:shadow-[0_0_0_3px_rgba(255,90,95,0.08)] outline-none transition-all";
