      ...
      <main className="flex-1 flex flex-col px-6 max-w-[420px] w-full mx-auto">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2.5">
            ...
            <input
              ...
              autoComplete="email"
              className="w-full h-[56px] rounded-[6px] bg-white px-5 text-[16px] text-[#111111] placeholder-[#9CA3AF] outline-none border-2 border-transparent focus:border-[#FF5A5F] transition-colors"
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-[56px] rounded-[6px] bg-white px-5 pr-14 text-[16px] text-[#111111] placeholder-[#9CA3AF] outline-none border-2 border-transparent focus:border-[#FF5A5F] transition-colors"
        ...
        <div className="flex justify-end mt-3 mb-7">
          <button
            ...
            className="text-[13px] font-medium text-[#FF5A5F]/70 hover:text-[#FF5A5F] transition-colors py-1"
