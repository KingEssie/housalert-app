            ...
            <div className="w-full mt-6">
              <div className="relative">
                <input
                  ...
                  className="w-full h-[56px] rounded-[8px] border border-[#D1D5DB] bg-white px-4 text-[16px] text-[#111111] placeholder:text-[#334855] placeholder:opacity-55 focus:outline-none focus:ring-1 focus:ring-ha-primary/25 focus:border-ha-primary transition-all pr-12"
