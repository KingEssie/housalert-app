        ...
        {loading ? (
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#F3F4F6] rounded-[20px] pl-6 pr-12 py-4 text-[16px] text-[#111827] placeholder:text-[#9CA3AF] border-0 outline-none focus:ring-2 focus:ring-[#0D6EFD]/20 h-[60px]"
