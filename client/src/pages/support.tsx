...
import { ChevronLeft, ExternalLink, MessageSquare, CheckCircle, Send } from "lucide-react";
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#f9f7f8" }}>
      <div
        ...
        style={{ backgroundColor: "#f9f7f8", borderBottom: "1px solid #ece7ef" }}
      >
        <button
      ...
      <div className="max-w-[480px] mx-auto px-4 py-6 space-y-5 pb-16">
        <div>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-[13px]" style={{ color: "#888888" }}>We reageren zo snel mogelijk.</p>
            </div>
          </div>
          ...
          {sent ? (
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                style={{ backgroundColor: "#f9f7f8", border: "1px solid #ece7ef", color: "#111111" }}
        ...
        <button
          ...
          className="w-full bg-white rounded-[28px] p-5 flex items-center gap-4 text-left active:opacity-80"
          style={{ border: "1px solid #ece7ef", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[16px] font-bold" style={{ color: "#111111" }}>Stuur ons een WhatsApp bericht</p>
            <p className="text-[13px]" style={{ color: "#888888" }}>Direct in gesprek met ons team.</p>
          </div>
        ...
        >
          <div className="px-5 pt-5 pb-3">
            <p className="text-[16px] font-bold" style={{ color: "#111111" }}>Vind je antwoord</p>
            <p className="text-[13px] mt-0.5" style={{ color: "#888888" }}>Bekijk onze veelgestelde vragen en informatie.</p>
          </div>
          {FAQ_LINKS.map((link, i) => (
            <div key={i}>
              ...
              >
                <p className="text-[15px] font-bold flex-1" style={{ color: "#111111" }}>{link.label}</p>
