    ...
    <div className="flex items-center gap-2 px-6 pt-6 pb-2">
      {Array.from({ length: total }, (_, i) => (
        <div
          ...
          style={{ backgroundColor: i < step ? "#2DD4BF" : "#EEEEEE" }}
          data-testid={`progress-step-${i + 1}`}
        />
      ))}
      <span className="text-[13px] font-medium text-[var(--yo-muted)] ml-1 whitespace-nowrap">
        {step}/{total}
      </span>
    </div>
  );
...
function WelcomeStep({ onStart }: { onStart: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
      <div
        className="w-[72px] h-[72px] rounded-[18px] bg-[#E6FAF5] flex items-center justify-center mb-8"
      >
        <Search className="w-8 h-8 text-[#2DD4BF]" />
      </div>
      ...
      <p
        className="text-[16px] leading-relaxed text-[var(--yo-muted)] mb-10 max-w-[320px]"
      ...
      <button
        onClick={onStart}
        className="w-full max-w-[320px] min-h-[56px] rounded-[14px] bg-[#2DD4BF] hover:bg-[#25BBA8] text-white font-bold text-[16px] transition-colors flex items-center justify-center gap-2 shadow-[0_2px_12px_rgba(45,212,191,0.25)]"
      ...
      <p className="text-[13px] text-[var(--yo-muted)] mt-4" data-testid="text-duration-hint">
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 pt-4">
      <div className="flex-1">
        <div className="w-[56px] h-[56px] rounded-[14px] bg-[#E6FAF5] flex items-center justify-center mb-6">
      ...
      <div className="pb-8 pt-4">
        <button
          ...
          className="w-full min-h-[56px] rounded-[14px] bg-[#2DD4BF] hover:bg-[#25BBA8] text-white font-bold text-[16px] transition-colors disabled:opacity-40 disabled:cursor-not-allowed shadow-[0_2px_12px_rgba(45,212,191,0.25)]"
...
function BudgetStep({
  ...
  return (
    <div className="flex flex-col min-h-screen px-6 pt-4">
      <div className="flex-1">
        <div className="w-[56px] h-[56px] rounded-[14px] bg-[#E6FAF5] flex items-center justify-center mb-6">
          <span className="text-[24px] font-bold text-[#2DD4BF]">&#8364;</span>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-[13px] font-semibold text-[var(--yo-muted)] uppercase tracking-wide mb-1.5">
              Minimale huurprijs (optioneel)
            </label>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--yo-muted)] text-[15px]">&#8364;</span>
              <input
                type="number"
                inputMode="numeric"
                placeholder="0"
                ...
                className="w-full min-h-[56px] rounded-[14px] bg-[var(--yo-surface)] border border-[var(--yo-divider)] pl-9 pr-4 text-[16px] text-[var(--yo-dark)] placeholder:text-[var(--yo-muted)] focus:outline-none focus:ring-2 focus:ring-[#2DD4BF] focus:border-transparent"
            ...
            <button
              ...
              className={`w-full min-h-[56px] rounded-[14px] border-2 px-5 text-left text-[16px] font-medium transition-all flex items-center justify-between ${
                propertyType === pt.value
                  ? "border-[#2DD4BF] bg-[#E6FAF5] text-[#2DD4BF]"
...
function AlertsStep({ onActivate, saving }: { onActivate: () => void; saving: boolean }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
      <div className="w-[72px] h-[72px] rounded-[18px] bg-[#E6FAF5] flex items-center justify-center mb-8">
        <Bell className="w-8 h-8 text-[#2DD4BF]" />
      </div>
      ...
      <p className="text-[16px] text-[var(--yo-muted)] mb-10 max-w-[300px] leading-relaxed">
      ...
      <button
        onClick={onActivate}
        disabled={saving}
        className="w-full max-w-[320px] min-h-[56px] rounded-[14px] bg-[#2DD4BF] hover:bg-[#25BBA8] text-white font-bold text-[16px] transition-colors disabled:opacity-60 flex items-center justify-center gap-2 shadow-[0_2px_12px_rgba(45,212,191,0.25)]"
