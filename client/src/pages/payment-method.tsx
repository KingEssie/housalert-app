...
export default function PaymentMethodPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#EBEBF0" }} data-testid="page-payment-method">
      <AppHeader title={t("paymentMethodPage.title")} />

      <div className="max-w-xl mx-auto p-4 space-y-4 pb-8">
        <div className="app-card">
          <div className="flex items-center gap-3">
            <div className="w-[48px] h-[48px] rounded-[8px] bg-[#EBEBF0] flex items-center justify-center flex-shrink-0">
