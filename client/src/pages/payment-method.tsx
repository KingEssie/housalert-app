...
export default function PaymentMethodPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "rgb(var(--ha-bg))" }} data-testid="page-payment-method">
      <AppHeader title={t("paymentMethodPage.title")} />

      <div className="max-w-xl mx-auto p-4 space-y-4 pb-8">
        <div className="app-card">
          <div className="flex items-center gap-3">
            <div className="w-[48px] h-[48px] rounded-[8px] bg-ha-surface flex items-center justify-center flex-shrink-0">
              <CreditCard className="w-5 h-5 text-ha-primary" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-[16px] font-semibold text-ha-text" data-testid="text-card-brand">
