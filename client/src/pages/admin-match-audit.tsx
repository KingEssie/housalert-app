...
export default function AdminMatchAudit() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#edf2f7]" data-testid="page-admin-audit">
      ...
      <div className="max-w-xl mx-auto px-4 pb-32 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-[#E5E7EB] p-4 space-y-3" data-testid="card-actions">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={loadData}
              className="flex items-center gap-2 px-4 py-2.5 bg-[#edf2f7] text-[#111111] rounded-xl text-[13px] font-semibold"
