...
export default function CheckoutSuccessPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-5" data-testid="page-checkout-success">
      <div className="text-center max-w-sm">
        ...
        <h1 className="text-[28px] font-bold text-[#111] mb-2" data-testid="text-checkout-title">
