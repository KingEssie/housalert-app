...
function PrimaryBtn({
  ...
  return (
    <button
      ...
      className="w-full h-[56px] rounded-[6px] text-[16px] font-bold text-white transition-all active:scale-[0.97] disabled:opacity-50 shadow-[0_4px_16px_rgba(255,90,95,0.3)]"
...
function LetterPersonalStep({
  ...
  const INPUT_CLS = "w-full h-[56px] px-4 rounded-[6px] border border-ha-card-border bg-ha-card text-[16px] text-ha-text placeholder:text-ha-text-secondary focus:outline-none focus:ring-2 focus:ring-[rgba(255,90,95,0.2)]";
  ...
  return (
    <>
      ...
      <textarea
        ...
        className="w-full flex-1 min-h-[280px] p-4 rounded-[6px] border border-ha-card-border bg-ha-card text-[14px] leading-[1.7] text-ha-text placeholder:text-ha-text-secondary focus:outline-none focus:ring-2 focus:ring-[rgba(255,90,95,0.2)] resize-none"
      ...
      {invited ? (
        ...
        <div className="flex gap-2 mb-6">
          <input
            ...
            className="flex-1 h-[56px] px-4 rounded-[6px] border border-ha-card-border bg-ha-card text-[16px] text-ha-text placeholder:text-ha-text-secondary focus:outline-none focus:ring-2 focus:ring-[rgba(255,90,95,0.2)]"
