        ...
        <div ref={cityContainerRef} className="relative">
          <div className="relative">
            ...
            <input
              ...
              className={`w-full min-h-[48px] rounded-[6px] bg-ha-surface border px-11 text-[16px] text-ha-text-muted placeholder:text-ha-text-secondary ${
        ...
        <div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full h-[48px] pl-11 pr-4 rounded-[6px] border border-transparent bg-ha-surface text-[15px] font-medium text-ha-text-muted cursor-pointer appearance-none"
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="w-full flex items-center justify-between min-h-[48px] px-4 rounded-[6px] bg-ha-surface border border-ha-card-border text-[15px] text-ha-text-muted hover:bg-ha-surface transition-colors"
