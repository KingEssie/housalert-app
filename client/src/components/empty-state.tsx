  ...
  return (
    <div className="flex flex-col items-center text-center pt-10" data-testid={testId}>
      <img
        ...
        draggable={false}
      />
      <h2 className="text-[20px] font-bold text-[#111827] leading-snug mb-2" data-testid="text-empty-title">
        {title}
      </h2>
      <p className="text-[14px] text-[#6B7280] leading-relaxed max-w-[280px] mb-6" data-testid="text-empty-description">
        {description}
      </p>
      <button
        onClick={onCtaClick}
        className="h-[48px] px-8 rounded-xl bg-[#673DE5] hover:bg-[#5B30D6] text-white text-[15px] font-semibold transition-colors"
