...
interface BuddyDisconnectSheetProps {
  open: boolean;
  onClose: () => void;
  onConfirm: () => void;
  loading?: boolean;
...
export function BuddyDisconnectSheet({ open, onClose, onConfirm, loading }: BuddyDisconnectSheetProps) {
  ...
  return (
    <div
      ...
      onClick={onClose}
      data-testid="overlay-buddy-disconnect"
    >
      <div
      ...
      >
        ...
        >
          ...
          {t("buddyV2.buddyDisconnectConfirm")}
        </button>
