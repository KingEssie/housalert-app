...
export function OwnerDisconnectSheet({ open, onClose, onConfirm, loading }: OwnerDisconnectSheetProps) {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-[18px] font-semibold text-[#000000] mb-2" data-testid="text-owner-disconnect-title">
          {t("zoekbuddyPage.ownerDisconnectTitle")}
        </p>
        <p className="text-[15px] text-[#6B7280] leading-snug mb-5" data-testid="text-owner-disconnect-desc">
