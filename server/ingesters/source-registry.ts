...
export const SOURCE_REGISTRY: SourceRegistryEntry[] = [
  ...
  },
  {
    ...
    status: "broken",
    priority: "high",
    note: "Returns 403 — Cloudflare bot protection",
    url: "https://www.kleinanzeigen.de",
    marketShare: "Massive inventory of private landlord listings. Very high value if unblocked.",
    blockerType: "bot-protection",
    estimatedListingsPerCity: 200,
    supportedCountries: ["DE"],
    implementationNotes: "Requires residential proxies or Playwright-based scraper with browser fingerprint. Consider Apify or ScrapingBee integration.",
  },
  {
    name: "immoscout24",
