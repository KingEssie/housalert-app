      ...
      await pool.query(
        `INSERT INTO source_health
         ...
         ON CONFLICT (source_name, city) DO UPDATE SET
           ...
           duplicate_count   = $8,
           error_count       = $9,
           last_error        = CASE WHEN NOT $4 THEN $10 ELSE NULL END,
           status            = $11,
           consecutive_failures = CASE WHEN $4 THEN 0 ELSE source_health.consecutive_failures + 1 END,
           consecutive_zeros    = CASE WHEN $12 THEN source_health.consecutive_zeros + 1 ELSE 0 END,
